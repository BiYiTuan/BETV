...
import com.szgvtv.ead.app.taijietemplates.dataprovider.packet.inpacket.InPacket;
import com.szgvtv.ead.app.taijietemplates.dataprovider.packet.outpacket.OutPacket;
import com.szgvtv.ead.app.taijietemplates.dataprovider.packet.outpacket.OutPacket.Method;
...
public class HttpEngine extends AsyncTask<Void, Void, Void>
{
	...
	private HttpURLConnection iniConn() throws ProtocolException, IOException 
	{
		...
		httpConn.setRequestProperty("Charset", Constant.ENCODING_UTF8);
	...
	{
		String result = Constant.ENCODING_UTF8;
		if (httpConn != null) 
		{
